...
distclean spotless: clean
	rm -f -r *.dSYM Makefile version.c mkdio.h libmarkdown.pc config.cmd config.sub config.h config.mak config.log config.md ./mktags ./blocktags ./librarian.sh
